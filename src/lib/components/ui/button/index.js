...
const buttonVariants = tv({
	base: [
		...
		'border-2 font-medium leading-6 ',
	...
	variants: {
		variant: {
			...
			'outline-primary':
				'border-primary-border bg-background text-primary-foreground hover:bg-accent hover:text-accent-foreground',
			'outline-secondary':
				'border-secondary-border bg-background text-secondary-foreground hover:bg-accent hover:text-accent-foreground',
			'outline-success':
				'border-success-foreground bg-background text-success-foreground hover:bg-accent hover:text-accent-foreground',
			'outline-warning':
				'border-warning-foreground bg-background text-warning-foreground hover:bg-accent hover:text-accent-foreground',
			'outline-danger':
				'border-danger-foreground bg-background text-danger-foreground hover:bg-accent hover:text-accent-foreground',
			'outline-destructive':
				'border-destructive-foreground bg-background text-destructive-foreground hover:bg-accent hover:text-accent-foreground',
